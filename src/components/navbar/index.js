import {Flex, Image, Text, HStack, useDisclosure, Box, Icon, Center, Stack} from '@chakra-ui/react';
...
const Navbar = ({transluscent, isLandingPage, navBarStyle, activePage}) => {
  ...
  return (
    <>
      ...
      <Box display={{base: 'flex', lg: 'none'}} {...navBarStyle?.mobile} mt={`0px !important`}>
        <Flex
          position={transluscent && 'absolute'}
          px={'20px'}
          zIndex={100}
            ...
            router.pathname === '/settings' ? (
              ...
              >
                {store_data?.business_name || `Your Logo`}
                  ...
                  <Stack spacing="none">
                    <Text fontSize={`15.531px`} color="#000" fontWeight={700}>
                      Adozillion
                    </Text>
                    <Text fontSize={`10.959px`} color="#000" fontWeight={400}>
                      Homes & Reality
                    </Text>
                  </Stack>
                </HStack>
