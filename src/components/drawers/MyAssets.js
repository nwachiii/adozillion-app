    ...
    >
      ...
      >
        ...
        {isLoading ? (
          ...
          <Box p={{ base: 6, md: 0 }} mt={{ base: '10px', md: "24px"}} overflowY='scroll'>
            {USER_EQUITY?.length > 0 ? (
              <>
                ...
                <HStack display={{ base: 'none', md: 'flex' }} spacing={'15px'} justify={'flex-end'}>
                  <Center
                    cursor={'pointer'}
              ...
              <EmptyState
                ...
                headerStyle={{textTransform: 'uppercase', fontWeight: 700}}
                height="300px"
