            ...
            {screen === 'history' ? (
              <Flex direction='row' justify='space-between' align={'center'}>
                <HStack spacing={'15px'}>
                  ...
                  <Text className="gilda-display-regular" color='text' fontSize={'25px'} fontWeight={500}>Feedback History</Text>
                </HStack>
                <CloseIcon color='text' cursor='pointer' fontSize='17px' onClick={feedModal?.onClose} />
              </Flex>
            ) : (
              <Flex direction='row' justify='space-between' align={'flex-start'}>
                <Text className="gilda-display-regular" color='text' fontSize={'25px'} fontWeight={500}>Feedback</Text>
                <HStack gap='5px'>
                  {feedbackData?.length && (
                  ...
                  <CloseIcon color='text' cursor='pointer' fontSize='17px' onClick={feedModal?.onClose} mt={2} />
                </HStack>
              </Flex>
            )}
          </Box>
                ...
                />
                    <Flex justify={'flex-end'} align={'center'} w='full'>
                      <Button
                        ...
                        disabled={submitFeedback.isLoading}
                        loading={submitFeedback.isLoading}
                        onClick={handleSubmit} w='full' align='right'
                        color='white' bg='primary' mt='30px' h='45px'
                        rounded='5px'
                      >
                        Submit
                      </Button>
