      ...
      <>
        {packetData?.received?.length ? (
          ...
          >
            {packetData?.received?.map((item, index) => (
              <Flex
                ...
                w="full"
                p={{base: ' 14.501px 15.686px 14.894px 20.25px', xl: '13px 18px 13.128px 18px'}}
                // shadow={'md'}
              ...
              >
                <Flex align={'center'} gap="10px">
                  ...
                  <VStack align={'flex-start'} spacing="0">
                    <Text color="text" fontSize={'15px'} fontWeight={500}>
                      Project report
                    </Text>
          ...
          <EmptyState
            ...
            text="No home owner's packet has been uploded"
          />
        )}
      </>
    );
      ...
      {HOME__OWNERS__PACKETS?.isLoading ? (
        ...
        <Box w="full" h="full">
          <Flex align={'flex-start'} justify={'space-between'} w="full" px="22px">
            <VStack align={'stretch'} justify="center" maxW={'80%'}>
              <Text
                ...
                {packetTabs.map((item, index) => (
                  ...
                  >
                    <Text
                      ...
                      w="56px"
                      fontWeight="400"
                      fontSize={{base: '12.826px', md: '16px'}}
                      whiteSpace="nowrap"
                    >
                      {item.tablist}
                    </Text>
  ...
  return (
    <>
      {isMobile ? (
        ...
        >
          <DrawerOverlay />
          <DrawerContent bg="card_bg" h="80vh !important" w="450px" py="24px">
            {mainContent}
          </DrawerContent>
        </Drawer>
      ) : (
        ...
        >
          <DrawerOverlay />
          <DrawerContent bg="card_bg" maxW="500px" py="24px">
            {mainContent}
          </DrawerContent>
        </Drawer>
      )}
